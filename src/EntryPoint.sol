...
import { Exec } from "src/lib/Exec.sol";
import { StakeManager } from "src/utils/StakeManager.sol";
import { SenderCreator } from "src/utils/SenderCreator.sol";
import "src/utils/Helpers.sol";
import { NonceManager } from "src/utils/NonceManager.sol";
import { ReentrancyGuard } from "openzeppelin-contracts/security/ReentrancyGuard.sol";
import { UserOperationLib, UserOperations } from "src/utils/UserOperations.sol";

contract EntryPoint is IEntryPoint, StakeManager, NonceManager, ReentrancyGuard {
    using UserOperationLib for UserOperations;
    ...
    function _executeUserOp(
        uint256 opIndex,
        UserOperations calldata userOp,
     ...
     * @param beneficiary the address to receive the fees
     */
    function handleOps(UserOperations[] calldata ops, address payable beneficiary) public nonReentrant {
        ...
        nonReentrant
    {
        ...
        for (uint256 i = 0; i < opasLen; i++) {
            ...
            UserOperations[] calldata ops = opa.userOps;
     ...
     */
    function getUserOpHash(UserOperations calldata userOp) public view returns (bytes32) {
     ...
     */
    function _copyUserOpToMemory(UserOperations calldata userOp, MemoryUserOp memory mUserOp) internal pure {
     ...
     */
    function simulateValidation(UserOperations calldata userOp) external {
    ...
    function _simulationOnlyValidations(UserOperations calldata userOp) internal view {
        // solhint-disable-next-line no-empty-blocks
